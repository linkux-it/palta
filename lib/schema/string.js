...
export class StringField extends TypeField {


  /**
   * String StringField constructor.
   *
   * @param {String} key
   ...
   */
  cast (value, doc, init) {
    if (StringField._isRef(this, value, doc, init)) {
  ...
  castForQuery ($conditional, val) {
    ...
    val = $conditional;
    if (Reflect.apply(Object.prototype.toString, val) === '[object RegExp]') {
      return val;
    }
